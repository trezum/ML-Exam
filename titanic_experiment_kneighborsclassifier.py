...
#Er scoren lavere fordi den score forkert?
#Skal gridsearchCV fitte på hele datasettet?????
space = dict()
space['algorithm'] = ['ball_tree', 'kd_tree', 'brute', 'auto']
space['weights'] = ['uniform', 'distance']
space['n_neighbors'] = range(1, 20)
space['metric'] = ['euclidean', 'manhattan', 'chebyshev', 'minkowski']


# Used for som debugging becaus F1 is behaving in an instresting way.
# space['algorithm'] = ['auto']
# space['weights'] = ['uniform']
#space['n_neighbors'] = [5,7]
...
# Used to show the resulting scores and test runs
